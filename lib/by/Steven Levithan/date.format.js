...
( function() {
    ...
    function format( mask ) {
        ...
        var lexemes = {
            ...
            yyyy : {
                name : 'year',
                valueOf : function( ) { return lexemes.date.getFullYear() },
            },
            p : {
                name : 'period',
        ...
        [ 'j', 'n', 'd', 'H', 'h', 'M', 'm', 's' ].each( function( ltr ) {
            var dual = ltr + ltr
        ...
        [ 'd', 'n' ].each( function( ltr ) {
            ...
            [ triple, quad ].each( function( lex ) {
                lexemes[ lex ] = lexemes[ lex ] || {
                    valueOf : function( ) {
                        var lang = this.lang || 'english' // ToDo: improve
                        return lexemes[ ltr ].types[ lang ][ type[ lex ] ][ lexemes[ ltr ] - 1 ]
                    },
                }
            } )
        } )
