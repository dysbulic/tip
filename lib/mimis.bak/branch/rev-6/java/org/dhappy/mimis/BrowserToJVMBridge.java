 ...
 */
public class BrowserToJVMBridge extends JApplet {
    private static Logger log =
	Logger.getLogger( BrowserToJVMBridge.class.getName() );
    
    public BrowserToJVMBridge() {
	log.info( "BrowserToJVMBridge constructed" );
    }
