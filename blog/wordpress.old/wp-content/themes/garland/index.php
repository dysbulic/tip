...
<div class="nextprev">
<div class="alignleft"><?php next_posts_link(__('&laquo; Older posts')) ?> <?php if ( is_singular() ) previous_post_link('&laquo; %link') ?></div>
<div class="alignright"><?php previous_posts_link(__('Newer posts &raquo;')) ?> <?php if ( is_singular() ) next_post_link('%link &raquo;') ?></div>
</div>
