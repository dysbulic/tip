...
var LandColor = [ 0.145,0.435,0.518,1]
var LandFrontColor = [0.216,0.647,0.765,0.85]
var CountryColor = [0.2,0.2,0.2,1]
var HeightColor = [0.216,0.647,0.765,0.85]
HeightColor = [1,0,0,1]
HeightColor = [0.459,0.851,0.972,1]
var Debug = false
...
function hex2num(hex) {
    ...
    var int1, int2
    for( var i = 0; i < 8; i += 2 ) {
	int1 = alphabet.indexOf( hex.charAt( i ) )
	int2 = alphabet.indexOf( hex.charAt( i + 1 ) )
...
function num2hex(triplet) {
	...
	int1 = v / 16
	int2 = v % 16
	hex += alphabet.charAt( int1 ) + alphabet.charAt( int2 ) 
    }
    return hex
}
...
function getWorldProgram() {
    if( WorldProgram === undefined ) {
        var $$m = mimis.load( '.../lib/mimis/xhtml' )
        console.log( $$m )
        var vertexshader = [
            '',
            '#ifdef GL_ES',
