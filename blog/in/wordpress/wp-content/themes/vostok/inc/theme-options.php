...
function vostok_theme_options_do_page() {
	...
	<div class="wrap">
		...
		<form method="post" action="options.php">
			...
			<?php $options = vostok_get_theme_options(); ?>
...
function vostok_theme_options_validate( $input ) {
	...
	$input['show-header-image'] = ( isset( $input['show-header-image'] ) && $input['show-header-image'] == 1 ? 1 : 0 );
	$input['show-header-nav'] = ( isset( $input['show-header-nav'] ) && $input['show-header-nav'] == 1 ? 1 : 0 );
