			<div <?php post_class(depo_post_category()) ?> id="post-<?php the_ID(); ?>">
				...
				<div class="entry">
					...
					<p class="meta"><?php the_tags(__('Tagged:', 'depo-squared') . ' ', ', ', ''); ?> on <?php the_time(get_option('date_format')) ?> <?php _e('by'); ?> <?php the_author() ?> <?php edit_post_link(__('Edit', 'depo-squared'), '', ''); ?></p>
