  ...
  <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		...
		<div <?php post_class(); ?> id="post-<?php the_ID(); ?>">
			...
			<div class="entry">
				...
				<nav id="nav-below">
					<h3 class="assistive-text"><?php _e( 'Post navigation', 'contempt' ); ?></h3>
					<span class="nav-previous"><?php previous_post_link( '%link', __( '&laquo; Previous Post', 'contempt' ) ); ?></span>
					<span class="nav-next"><?php next_post_link( '%link', __( 'Next Post &raquo;', 'contempt' ) ); ?></span>
				</nav><!-- #nav-below -->
