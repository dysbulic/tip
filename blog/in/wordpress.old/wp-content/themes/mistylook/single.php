...
<?php if (have_posts()) : ?>
		...
		<?php while (have_posts()) : the_post(); ?>
			...
			<div <?php post_class(); ?> id="post-<?php the_ID(); ?>">
				...
				<p class="postmetadata"><?php printf(__('Posted in %s','mistylook'), get_the_category_list(', ')); ?> | <?php the_tags( __('Tagged','mistylook').' ', ', ', ' | ' ); ?><?php comments_number(__('Leave a Comment','mistylook'), __('1 Comment','mistylook'), __('% Comments','mistylook')); ?></p>
