	...
	<h3 id="comments">
		...
		<span class="comment-message">
			<?php if ( comments_open() && pings_open() ) {
				printf( __( '<a href="#respond">Post your own</a> or leave a trackback: <a href="%1$s">Trackback URL</a>', 'weu-wei' ), get_trackback_url() );
			} elseif ( comments_open() && ! pings_open() ) {
				_e( '<a href="#respond">Post your own</a>', 'wu-wei' );
			} elseif ( ! comments_open() && pings_open() ) {
				printf( __( 'Leave a trackback: <a href="%1$s">Trackback URL</a>', 'weu-wei' ), get_trackback_url() );
			} elseif ( ! comments_open() && ! pings_open() ) {
