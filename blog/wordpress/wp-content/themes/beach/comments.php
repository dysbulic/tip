...
if ( ! function_exists( 'beach_comment' ) ) :
/**
 * Template for comments and pingbacks.
 *
 * To override this walker in a child theme without modifying the comments template
 * simply create your own beach_comment(), and that function will be used instead.
 *
...
endif; // ends check for beach_comment()

?>

	<div id="comments">
	<?php if ( post_password_required() ) : ?>
		<div class="nopassword"><?php _e( 'This post is password protected. Enter the password to view any comments.', 'beach' ); ?></div>
	</div><!-- .comments -->
	<?php return;
		endif;
	?>
	...
	<?php else : // this is displayed if there are no comments so far ?>
		...
		<?php else : // or, if we don't have comments:
			...
			?>
			<p class="nocomments"><?php _e( 'Comments are closed.', 'beach' ); ?></p>
