...
<div id="content">
	...
	<div <?php post_class('entry entry-' . $postCount); ?> id="post-<?php the_ID(); ?>">
		...
		<div class="entrymeta"><?php edit_post_link(__('Edit','treba'), '', ' | '); ?> <?php comments_popup_link(__('Leave a Comment &#187;','contempt'),__('1 Comment','contempt'),__('% Comments','contempt')); ?><br /><?php the_tags('Tags: ', ', ', '<br />'); ?></p>
		</div>
