$! Helpdesk nag reminder
$!  If run in the foreground will run checkin at 15 and 45 after
$!   and roomcount at 30 after.
...
$!
$ if f$locate("-hd.", f$getdvi("sys$output","tt_accpornam")) .eqs. -
    f$locate("-ts.", f$getdvi("sys$output","tt_accpornam")) -
    then goto end
$!
$ if f$getjpi("", "efcu") .eq. 0
$ then
$   interactive := false
$ else
$   interactive := true
...
$ then
$   procname = f$extract(0, 15, username + "s hd nag")
$   ctx = ""
