...
# https://raw.githubusercontent.com/sveint/spotify-notify/master/spotify-notify.py

import dbus
from dbus.mainloop.glib import DBusGMainLoop

#import gobject, gtk, os, tempfile, sys, time, re, urllib2
import gtk, os, tempfile, sys, time, re, urllib2
...
class SpotifyNotify():
    ...
    def pollChange(self):
        try:
            ...
            self.spotifyservice = self.bus.get_object('org.mpris.MediaPlayer2.spotify', '/')
