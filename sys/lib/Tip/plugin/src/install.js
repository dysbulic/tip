 ...
 * Modified for Tip plugin by Will Holcomb <will@technoanarchy.org>
 */

var XpiInstaller = {
 extFullName: 'Tip', // The name displayed to the user (don't include the version)
 extShortName: 'tip', // The leafname of the JAR file (without the .jar part)
 extVersion: '0.1',
 extAuthor: 'Will Holcomb',
 extLocaleNames: null, // e.g. ['en-US', 'en-GB']
 extSkinNames: null, // e.g. ['classic', 'modern']
 extPostInstallMessage: null, // 'Success! Please restart your browser to finish the installation.', // Set to null for no post-install message
